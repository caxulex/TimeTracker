...
export function ProjectsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* AI Project Health Modal */}
      <Modal
        isOpen={!!(projectHealthEnabled && selectedProjectForHealth)}
        onClose={() => setSelectedProjectForHealth(null)}
        title={selectedProjectForHealth ? `AI Health Analysis: ${selectedProjectForHealth.name}` : 'AI Health Analysis'}
        size="lg"
      >
        {selectedProjectForHealth && (
          <ProjectHealthCard
