...
import { YourStatsCard } from '../components/dashboard/YourStatsCard';
...
export function DashboardPage() {
  ...
  // Timer store — for live Today computation
  const isTimerRunning = useTimerStore((s) => s.isRunning);
  const isTimerPaused = useTimerStore((s) => s.isPaused);

  // User's personal dashboard — polls every 60s to keep week/month/projects fresh
