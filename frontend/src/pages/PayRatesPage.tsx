...
export const PayRatesPage: React.FC = () => {
  ...
  // Fetch all users for the dropdown. We pull a generous page so
  // small/mid-size tenants get everyone client-side; the UserSelect
  // itself caps at 100 when it owns the fetch, but PayRates can
  // legitimately want more since it lists every paid employee.
              ...
              {!editingRate && (
                <div>
                  ...
                  <UserSelect
                    ...
                    ariaLabel="Employee"
                  />
                  {/* Hidden input keeps native form-required parity. */}
