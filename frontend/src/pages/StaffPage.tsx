      ...
      {showCredentialsSummary && createdUserCredentials && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 overflow-hidden">
            ...
            {emailSent && (
              <div className="mx-6 mb-2 p-3 bg-green-50 border border-green-200 rounded-lg flex items-start gap-2">
                <svg className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span className="text-sm text-green-700">Welcome email sent successfully!</span>
              </div>
            )}
            ...
            <div className="px-6 py-4 bg-gray-50 space-y-3">
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={async () => {
                    ...
                    setEmailSent(false);
                    try {
                      const response = await companiesApi.sendWelcomeCredentials({
                        recipient_email: createdUserCredentials.email,
                        recipient_name: createdUserCredentials.name,
                        temporary_password: createdUserCredentials.password,
                        job_title: createdUserCredentials.job_title || undefined,
                        department: createdUserCredentials.department || undefined,
                      });
                      if (response.success) {
                        setEmailSent(true);
                  ...
                  className={`flex-1 flex items-center justify-center space-x-2 font-medium py-2.5 px-4 rounded-lg transition-colors ${
                    emailSent
              ...
              <button
                ...
                className="w-full flex items-center justify-center space-x-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium py-2.5 px-4 rounded-lg transition-colors"
              >
                <span>Close</span>
              </button>
            </div>
